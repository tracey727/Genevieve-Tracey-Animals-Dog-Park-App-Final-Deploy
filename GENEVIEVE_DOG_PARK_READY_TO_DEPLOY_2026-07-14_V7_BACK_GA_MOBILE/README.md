...
- The footer and More page display build **2026.07.14.7** so the live version can be identified immediately.


## Voluntary check-in policy

Check-in and check-out are optional community features in build 2026.07.14.7. The app must not present the displayed count as an official headcount or require participation unless a competent authority formally adopts and verifies such a requirement.
