...
const VERSION='2026.07.14.7';
const ASSETS=[
  './','./index.html','./styles.css?v=20260714.7','./config.js?v=20260714.7','./logic.js?v=20260714.7',
  './app.js?v=20260714.7','./backend.js?v=20260714.7','./native-billing-bridge.js?v=20260714.7',
  './manifest.webmanifest?v=20260714.7','./assets/app-icon-192.png','./assets/app-icon-512.png',
  './assets/genevieve-ga-logo-approved-original.png',
  './assets/genevieve-ga-logo-approved-mobile-display.png',
